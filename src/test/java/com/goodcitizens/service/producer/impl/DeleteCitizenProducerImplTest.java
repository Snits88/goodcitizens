...
public class DeleteCitizenProducerImplTest {
    ...
    @Test
    public void testWithDeleteProducer() throws IOException {
        CitizenTO citizenTO = getCitizenTO();
        CitizenEventTO event = CitizenTOtoCitizenEventTOConverter.convert(citizenTO);
        deleteCitizenProducer.notify(citizenTO);
        Message<String> received = (Message<String>) messageCollector.forChannel(citizenStreams.outboundDeleteCitizens()).poll();
