...
public interface ErrorMsg {
    ...
    String INVALID_OFFSET_MSG = "offset invalid. It must be a valid positive number";
    String INVALID_OFFSET_CODE = "000-000-009";

    String INVALID_LIMIT_MSG = "limit invalid. It must be a valid number number greater than 0";
    String INVALID_LIMIT_CODE = "000-000-010";

    String INVALID_ORDER_BY_MSG = "Order By invalid. Insert another value";
    String INVALID_ORDER_BY_CODE = "000-000-011";
}
